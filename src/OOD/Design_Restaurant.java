...
public class Design_Restaurant {
    /**
     * No food delivery.
     *
     ...
     *
     * The restaurant will choose the smallest table which fit the numbers of people(For example,
     * if the party has 3 people, the restaurant would assign a 4-people table instead of a 10-people table)
     *
