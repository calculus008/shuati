...
public class LI_231_Typeahead {
    /**
     * Implement typeahead. Given a string and a dictionary, return all words that
     * contains the string as a substring. The dictionary will give at the initialize
     * method and wont be changed. The method to find all words with given substring
