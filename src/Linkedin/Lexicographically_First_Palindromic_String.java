...
public class Lexicographically_First_Palindromic_String {
    /**
     * Rearrange the characters of the given string to form a lexicographically first
     * palindromic string. If no such string exists display message “no palindromic string”.
     *
     * Examples:
     *
     * Input : malayalam
