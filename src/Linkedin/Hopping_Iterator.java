 ...
 * @param <T>
 */
public class Hopping_Iterator<T> implements Iterator<T> {
    Iterator<T> iterator = null;
    int hops = -1;
    boolean firstTime = false;

    public Hopping_Iterator(Iterator<T> iterator, int hops) {
    ...
    public static void main(String[] args) {
        ...
        Hopping_Iterator<Integer> hi = new Hopping_Iterator<Integer>(list.iterator(), 3);
