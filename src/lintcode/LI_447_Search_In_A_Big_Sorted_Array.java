...
public class LI_447_Search_In_A_Big_Sorted_Array {
    /**
         ...
         Find the first index of a target number. Your algorithm should be in O(log k), where k is the
    ...
    public int searchBigSortedArray(ArrayReader reader, int target) {
        /**
         * !!!
         * First, find right boundary by expand it using factor 2,
         * kind of reverse of binary search.
         **/
        int index = 1;
        ...
        while (start + 1 < end) {
            ...
            if (reader.get(mid) == target) {
                /**
                 * since we try to find out the first index of target,
                 * we need to move the range left side.
                 *
                 * if we try to find the last index, we move right side.
        ...
        /**
         * again, try to find first index, so check start first, then check end
         */
