...
public class Reservior_Sampling {
    /**
     * given a stream of integer, randomly choose k elements from n,
     * ensure each value among k has equal probability.
     *
     * Given a function Rand01Uniform() which generates a random integer
     * number from [0,1] with a uniform distribution, write a function
     * Rand06Uniform() which generates a random integer number from [0,6]
...
//    		res[i] = Math.round(thisPerson);
    ...
    public static void main(String[] args) {
        double[] res = new Reservior_Sampling().distribute(5, 100);
        for (double val : res) {
