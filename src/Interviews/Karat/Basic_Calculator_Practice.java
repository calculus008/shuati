...
public class Basic_Calculator_Practice {
...
//        System.out.println(sign + "," + num);
    ...
    static String calculateWithQueue3 (String s, Map<String, Integer> map) {
        if (s == null || s.length() == 0) return "";

        Deque<Character> q = new ArrayDeque<>();

        /**
         * while putting in queue, if string key exits in map, replace it with
         * int value, we are doing translation here.
         */
        ...
        //should be "(1+8)-(pressure+3-(5+8)+2)+yy"
//        StringBuilder b = new StringBuilder();
//        for(Character c : q) {
//            System.out.println(c);
//            b.append(c);
//        }
//        System.out.println("converted input:" + b.toString());
    ...
    private static Pair helper2(Deque<Character> q,  Map<String, Integer> map) {
        ...
        while (!q.isEmpty()) {
            ...
            if (Character.isDigit(c)) {
                ...
                /**
                 * !!!
                 * For each recursion, we get Pair object
                 * back, with both in value and string value
                 */
                Pair p = helper2(q, map);

                /**
                 * !!!
                 * remember to use sign here
                 */
                res += sign * p.val;

                if (p.str.length() != 0) {
                    /**
                     * if it's '-' before '(', we need to flip '+' and '-'
                     * before putting it into sb
                     */
                    if (sign == -1) {
                ...
                /**
                 * !!!
                 * remember to put sign here
                 */
                sb.append(sign == 1 ? "+" : "-");
                /**
                 * Must put c here, otherwise first char is missing
                 */
                sb.append(c);
...
//        calculateWithQueue3("(e + 8) - (pressure + 3 - (temperature + 8) + y) +yy", map);
    }
}
