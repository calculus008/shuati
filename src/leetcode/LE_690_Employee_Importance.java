...
public class LE_690_Employee_Importance {
    /**
    ...
    class Solution {
        ...
        private int dfs(Integer id, Map<Integer, Employee> map) {
            ...
            for (Integer val : map.get(id).subordinates) {
                sum += dfs(val, map);
            }
        ...
        private int bfs(Integer id, Map<Integer, Employee> map) {
            ...
            while (!ids.isEmpty()) {
                ...
                for (Integer val : map.get(cur).subordinates) {
                    ids.offer(val);
                }
            }
