...
public class LE_682_Baseball_Game {
    /**
    ...
    /**
     * From official version suggests the stack will not be empty when running into "D", "C" and "+".
     * so we don't need to check if stack is empty before each operation. But better communicate with
     * interviewer to clarify, otherwise add those checks.
     */
    class Solution {
        public int calPoints(String[] ops) {
            ...
            for (String op : ops) {
                ...
                if (op.equals("+")) {
                    ...
                    /**
                     * we have to save the top element and later put it back,
                     * otherwise we will lose it and the sum will be wrong
                     */
                    if (!stack.isEmpty()) {
                        int top = stack.pop();
                        cur += top;
