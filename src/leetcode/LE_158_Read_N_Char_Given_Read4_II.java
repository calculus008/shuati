...
public class LE_158_Read_N_Char_Given_Read4_II {
     ...
     */
    /*
        Called multiple times, we need to deal the case that there are still chars left in buff from the last call.
        Therefore, we need to global variables to track:
    ...
    */
    ...
    public int read(char[] buf, int n) {
        ...
        while (ptr < n) {
            ...
            if (buffCnt == 0) break;//nothing read from stream
