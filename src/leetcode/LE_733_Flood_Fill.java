...
public class LE_733_Flood_Fill {
    /**
    ...
    class Solution {
        public int[][] floodFill(int[][] image, int sr, int sc, int newColor) {
            ...
            return helper(image, sr, sc, image.length, image[0].length, image[sr][sc], newColor);
        }

        private int[][] helper(int[][] image, int x, int y, int  m, int n, int curColor, int newColor) {
            ...
            helper(image, x + 1, y, m, n, curColor, newColor);
            helper(image, x - 1, y, m, n, curColor, newColor);
            helper(image, x, y + 1, m, n, curColor, newColor);
            helper(image, x, y - 1, m, n, curColor, newColor);
