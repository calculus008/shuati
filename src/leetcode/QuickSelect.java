...
public final class QuickSelect {
    ...
    private static int partition(int[] array, int left, int right, int pivotIndex) {
        ...
        int storeIndex = left;
        System.out.println("pivot=" + pivotValue + ",storeIndex="+storeIndex);
        System.out.println("======");
        ...
        for(int i = left; i < right; i++) {
            ...
            System.out.println("i = " + i + ", storeIndex=" + storeIndex);
            System.out.println(Arrays.toString(array));
            System.out.println("------");
        }
        System.out.println("right = " + right  + ", storeIndex=" + storeIndex);
    ...
    private static void swap(int[] array, int a, int b) {
        System.out.println("swap a["+a+"] and a["+b+"]");
        int tmp = array[a];
        array[a] = array[b];
        array[b] = tmp;
    }
...
//        int[] array = {3,2,1,5,6,4};
        ...
        int[] array = {-1,2,0};
        System.out.println(selectIterative(array, 2));
