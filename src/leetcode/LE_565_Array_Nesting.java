...
public class LE_565_Array_Nesting {
    /**
     ...
     *
     * Time and Space : O(n)
     * Can mark visited in nums by setting it to n or Integer.MAX_VALUE, if change input is allowed.
     * Then time will be O(1)
     */
    ...
    public class Solution_with_visited_array {
        public int arrayNesting(int[] nums) {
            int n = nums.length;
